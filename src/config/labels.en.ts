...
export const labelsEn: Labels = {
	...
	guestbookSubtitle: 'Leave a message for the couple',
	guestbookNameLabel: 'Name',
	guestbookNamePlaceholder: 'Enter your name',
	guestbookMessageLabel: 'Message',
	guestbookMessagePlaceholder: 'Share your warm wishes',
	guestbookSubmit: 'Post',
	guestbookSubmitting: 'Posting...',
	guestbookEmpty: 'No messages yet.\nBe the first to leave a message!',
	guestbookLoading: 'Loading messages...',
	guestbookLoadError: 'Could not load the guestbook.',
	guestbookError: 'Failed to post. Please try again.',
	guestbookThankYou: 'Your message has been posted.',
	guestbookShowAll: 'Show all',
	guestbookShowLess: 'Show less',
