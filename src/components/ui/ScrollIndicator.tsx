...
export default function ScrollIndicator({
	...
	return (
		<div
			ref={barRef}
			className={`sticky top-0 z-40 bg-cream/90 backdrop-blur-md border-b border-beige/20 transition-opacity duration-700 ${visible ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}
		>
			{/* 프로그래스 바 */}
